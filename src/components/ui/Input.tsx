  ...
  return (
    <label className="grid gap-2 text-body-sm font-semibold text-text-primary" htmlFor={inputId}>
      ...
      <input
        ...
        className={`min-h-[46px] w-full border bg-surface-strong px-3 text-body text-text-primary placeholder:text-text-placeholder focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-focus-ring ${
  ...
  return (
    <label className="grid gap-2 text-body-sm font-semibold text-text-primary" htmlFor={textareaId}>
      ...
      <textarea
        aria-describedby={error ? errorId : undefined}
        aria-invalid={Boolean(error)}
        className={`min-h-24 w-full resize-none rounded-sm border bg-surface-strong p-3 text-body text-text-primary placeholder:text-text-placeholder focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-focus-ring md:resize-y ${
